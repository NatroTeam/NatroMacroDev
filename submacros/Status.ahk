...
settings["MondoLootDirection"] := {enum: 66, type: "str", section: "Collect", regex: "i)^(Left|Right|Random)$"}
settings["PlanterName1"] := {enum: 67, type: "str", section: "Planters", regex: "i)^(PlasticPlanter|CandyPlanter|BlueClayPlanter|RedClayPlanter|TackyPlanter|PesticidePlanter|HeatTreatedPlanter|HydroponicPlanter|PetalPlanter|PlanterOfPlenty|PaperPlanter|TicketPlanter)$"}
settings["PlanterName2"] := {enum: 68, type: "str", section: "Planters", regex: "i)^(PlasticPlanter|CandyPlanter|BlueClayPlanter|RedClayPlanter|TackyPlanter|PesticidePlanter|HeatTreatedPlanter|HydroponicPlanter|PetalPlanter|PlanterOfPlenty|PaperPlanter|TicketPlanter)$"}
settings["PlanterName3"] := {enum: 69, type: "str", section: "Planters", regex: "i)^(PlasticPlanter|CandyPlanter|BlueClayPlanter|RedClayPlanter|TackyPlanter|PesticidePlanter|HeatTreatedPlanter|HydroponicPlanter|PetalPlanter|PlanterOfPlenty|PaperPlanter|TicketPlanter)$"}
settings["PlanterField1"] := {enum: 70, type: "str", section: "Planters", regex: "i)^(None|Bamboo|Blue Flower|Cactus|Clover|Coconut|Dandelion|Mountain Top|Mushroom|Pepper|Pine Tree|Pineapple|Pumpkin|Rose|Spider|Strawberry|Stump|Sunflower)$"}
settings["PlanterField2"] := {enum: 71, type: "str", section: "Planters", regex: "i)^(None|Bamboo|Blue Flower|Cactus|Clover|Coconut|Dandelion|Mountain Top|Mushroom|Pepper|Pine Tree|Pineapple|Pumpkin|Rose|Spider|Strawberry|Stump|Sunflower)$"}
settings["PlanterField3"] := {enum: 72, type: "str", section: "Planters", regex: "i)^(None|Bamboo|Blue Flower|Cactus|Clover|Coconut|Dandelion|Mountain Top|Mushroom|Pepper|Pine Tree|Pineapple|Pumpkin|Rose|Spider|Strawberry|Stump|Sunflower)$"}
settings["PlanterNectar1"] := {enum: 73, type: "str", section: "Planters", regex: "i)^(None|Comforting|Refreshing|Satisfying|Motivating|Invigorating)$"}
settings["PlanterNectar2"] := {enum: 74, type: "str", section: "Planters", regex: "i)^(None|Comforting|Refreshing|Satisfying|Motivating|Invigorating)$"}
settings["PlanterNectar3"] := {enum: 75, type: "str", section: "Planters", regex: "i)^(None|Comforting|Refreshing|Satisfying|Motivating|Invigorating)$"}
settings["PlanterHarvestFull1"] := {enum: 76, type: "str", section: "Planters", regex: "i)^(Full|Timed)$"}
settings["PlanterHarvestFull2"] := {enum: 77, type: "str", section: "Planters", regex: "i)^(Full|Timed)$"}
settings["PlanterHarvestFull3"] := {enum: 78, type: "str", section: "Planters", regex: "i)^(Full|Timed)$"}
settings["NatroSoBroke"] := {enum: 82, type: "str", section: "Settings", regex: "i)^(.{1,50})"}
settings["PrinterItem1"] := {enum: 83, type: "str", section: "Collect", regex: "i)^(gifted)?(Silver|Gold|Diamond|Mythic)$|^(Basic|Star)$"}
settings["PrinterItem2"] := {enum: 84, type: "str", section: "Collect", regex: "i)^(gifted)?(Silver|Gold|Diamond|Mythic)$|^(Basic|Star)$"}
...
settings["PrinterIndex"] := {enum: 273, type: "int", section: "Collect", regex: "i)^(1|2)$"}
settings["LastStickerPrinter"] := {enum: 274, type: "int", section: "Collect", regex: "i)^\d{1,10}$"}
...
settings["HoneyUpdateSSCheck"] := {enum: 361, type: "int", section: "Status", regex: "i)^(0|1)$"}
settings["MeteorShowerCheck"] := {enum: 362, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["LastMeteorShower"] := {enum: 363, type: "int", section: "Collect", regex: "i)^\d{1,10}$"}
settings["PresetInterval"] := {enum: 364, type: "int", section: "Settings", regex: "^\d{1,3}$"}
...
settings["PriorityListNumeric"] := {enum: 368, type: "int", section: "Settings", regex: "i)^[1-9]{9}$"}
settings["lastPresetChange"] := {enum: 369, type: "int", section: "Settings", regex: "^i)^\d{1,10}$"}
settings["PrinterAmount1"] := {enum: 370, type: "int", section: "Collect", regex: "i)^\d{1,99}$"}
settings["PrinterAmount2"] := {enum: 371, type: "int", section: "Collect", regex: "i)^\d{1,99}$"}
settings["PrinterTimer1"] := {enum: 372, type: "int", section: "Collect", regex: "i)^\d{1,999}$"}
settings["PrinterTimer2"] := {enum: 373, type: "int", section: "Collect", regex: "i)^\d{1,999}$"}
bitmaps := Map()
...
{
	static id := ""
	if HoneyUpdate && HoneyUpdateSSCheck
	{
...
nm_command(command)
{
	...
	switch (name := params[1]), 0
	{
		...
		UI := SubStr(command.content, 11) ; user input
		if !(UI) {
	...
	timerAdjust(time, type:=0) {
		...
		lastPresetChange := lastPresetChange += time_delta
