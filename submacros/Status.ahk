...
settings["ShrineItem1"] := {enum: 55, type: "str", section: "Shrine", regex: "i)^(strawberries|sunflowers|pineapples|Blueberries|blueextract|redextract|glue|oil|enzymes|gumdrops|tropicaldrink|mooncharms|glitter|starjelly|purplepotion|antpass|cloudvial|softwax|hardwax|swirledwax|causticwax|fielddice|smoothdice|loadeddice|Turpentine|Silver|Gold|Diamond|Mythic|Star|GiftedSilver|GiftedGold|GiftedDiamond|GiftedMythic)$"}
