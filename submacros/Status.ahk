...
settings["MicroConverterMatchIgnoreCheck"] := {enum: 322, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["SunflowerSeedMatchIgnoreCheck"] := {enum: 323, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["JellyBeanMatchIgnoreCheck"] := {enum: 324, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["RoyalJellyMatchIgnoreCheck"] := {enum: 325, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["TicketMatchIgnoreCheck"] := {enum: 326, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["CyanTrimMatchIgnoreCheck"] := {enum: 327, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["OilMatchIgnoreCheck"] := {enum: 328, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["StrawberryMatchIgnoreCheck"] := {enum: 329, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["CoconutMatchIgnoreCheck"] := {enum: 330, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["TropicalDrinkMatchIgnoreCheck"] := {enum: 331, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["RedExtractMatchIgnoreCheck"] := {enum: 332, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["MagicBeanMatchIgnoreCheck"] := {enum: 333, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["PineappleMatchIgnoreCheck"] := {enum: 334, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["StarJellyMatchIgnoreCheck"] := {enum: 335, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["EnzymeMatchMatchIgnoreCheck"] := {enum: 336, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["BlueExtractMatchIgnoreCheck"] := {enum: 337, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["GumdropMatchIgnoreCheck"] := {enum: 338, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["FieldDiceMatchIgnoreCheck"] := {enum: 339, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["MoonCharmMatchIgnoreCheck"] := {enum: 340, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["BlueberryMatchIgnoreCheck"] := {enum: 341, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["GlitterMatchIgnoreCheck"] := {enum: 342, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["StingerMatchIgnoreCheck"] := {enum: 343, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["TreatMatchIgnoreCheck"] := {enum: 344, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["GlueMatchIgnoreCheck"] := {enum: 345, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["CloudVialMatchIgnoreCheck"] := {enum: 346, type: "int", section: "Collect", regex: "i)^(0|1)$"}
settings["PineappleMatchIgnoreCheck"] := {enum: 347, type: "int", section: "Collect", regex: "i)^(0|1)$"}
