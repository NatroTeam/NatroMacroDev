...
global statusConfigLoc := "features\All\Quests\nm_status_config.ini"

;this is this features GUI lines-of-code used to calculate loading progress
StatusFeatureProgressVolume := (StatusFeature) ? 20 : 0
;this is the running total of all macro features included in the load progress metric
LoadingProgressVolume := (StatusFeature) ? LoadingProgressVolume+StatusFeatureProgressVolume : LoadingProgressVolume
...
nm_StatusTab(*) {
	...
	nm_setStats()
	CurrentLoadProgress:=CurrentLoadProgress+StatusFeatureProgressVolume
