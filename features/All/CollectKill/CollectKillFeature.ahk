...
global collectKillConfigLoc := "features\All\CollectKill\nm_collectkill_config.ini"

;this is this features GUI lines-of-code used to calculate loading progress
CollectKillFeatureProgressVolume := (CollectKillFeature) ? 218 : 0
;this is the running total of all macro features included in the load progress metric
LoadingProgressVolume := (CollectKillFeature) ? LoadingProgressVolume+CollectKillFeatureProgressVolume : LoadingProgressVolume


nm_includeCollectKillFeature(*){
	global
	nm_importCollectKillConfig()
}
...
nm_importCollectKillConfig()
{
	...
	local inipath := A_WorkingDir "\" collectKillConfigLoc
...
nm_CollectKillTab(*) {
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "x10 y57 vClockCheck Disabled Checked" ClockCheck, "Clock (tickets)")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "x10 yp+18 w50 vMondoBuffCheck Disabled Checked" MondoBuffCheck, "Mondo")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    ...
    (GuiCtrl := MainGui.Add("Edit", "xs+20 ys+3 w30 h18 number Limit3 vMondoSecs Disabled Hidden" (MondoAction != "Buff"), ValidateInt(&MondoSecs, 120))).Section := "Collect", GuiCtrl.OnEvent("Change", nm_saveCollectKillConfig)
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "x10 y112 w35 vAntPassCheck Disabled Checked" AntPassCheck, "Ant")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "x10 yp+17 vHoneystormCheck Disabled Checked" HoneystormCheck, "Honeystorm")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    ;memory match
    MainGui.SetFont("w700")
    MainGui.Add("GroupBox", "x5 y168 w125 h68 vMemoryMatchGroupBox", "Memory Match")
    MainGui.SetFont("s8 cDefault Norm", "Tahoma")
    (GuiCtrl := MainGui.Add("CheckBox", "x10 yp+15 w58 vNormalMemoryMatchCheck Disabled Checked" NormalMemoryMatchCheck, "Normal")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "xp+58 yp-18 wp vMegaMemoryMatchCheck Disabled Checked" MegaMemoryMatchCheck, "Mega")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 wp vExtremeMemoryMatchCheck Disabled Checked" ExtremeMemoryMatchCheck, "Extreme")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    MainGui.Add("Button", "x43 yp+16 w49 h16 vMemoryMatchOptions Disabled", "Options").OnEvent("Click", nm_MemoryMatchOptions)
    SetLoadingProgress(floor((CurrentLoadProgress+37)/LoadingProgressVolume*100))
	;dispensers
    MainGui.SetFont("w700")
    MainGui.Add("GroupBox", "x135 y42 w165 h105 vDispensersGroupBox", "Dispensers")
    MainGui.SetFont("s8 cDefault Norm", "Tahoma")
    (GuiCtrl := MainGui.Add("CheckBox", "x140 y57 vHoneyDisCheck Disabled Checked" HoneyDisCheck, "Honey")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vTreatDisCheck Disabled Checked" TreatDisCheck, "Treat")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vBlueberryDisCheck Disabled Checked" BlueberryDisCheck, "Blueberry")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vStrawberryDisCheck Disabled Checked" StrawberryDisCheck, "Strawberry")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vCoconutDisCheck Disabled Checked" CoconutDisCheck, "Coconut")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp+85 y57 vRoyalJellyDisCheck Disabled Checked" RoyalJellyDisCheck, "Royal Jelly")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vGlueDisCheck Disabled Checked" GlueDisCheck, "Glue")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vRoboPassCheck Disabled Checked" RoboPassCheck, "Robo Pass")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    ;beesmas
    beesmasActive := 0
    MainGui.SetFont("w700")
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "x350 yp+4 vBeesmasGatherInterruptCheck Disabled", "Allow Gather Interrupt")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "x140 yp+14 Section vStockingsCheck Disabled", "Stockings")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vWreathCheck Disabled", "Honey Wreath")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vFeastCheck Disabled", "Feast")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vRBPDelevelCheck Disabled", "Robo Party De-level")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp+120 ys vGingerbreadCheck Disabled", "Gingerbread")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vSnowMachineCheck Disabled", "Snow Machine")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vCandlesCheck Disabled", "Candles")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vWinterMemoryMatchCheck Disabled", "Winter Memory Match")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp+130 ys+6 vSamovarCheck Disabled", "Samovar")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vLidArtCheck Disabled", "Lid Art")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vGummyBeaconCheck Disabled", "Gummy Beacon")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
	...
	SetLoadingProgress(floor((CurrentLoadProgress+76)/LoadingProgressVolume*100))
    ;Blender
    MainGui.SetFont("w700")
    ...
    GuiCtrl.Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "x20 y120 w13 h13 vBugrunLadybugsLoot Disabled Hidden Checked" BugrunLadybugsLoot)).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 w13 h13 vBugrunRhinoBeetlesLoot Disabled Hidden Checked" BugrunRhinoBeetlesLoot)).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 w13 h13 vBugrunSpiderLoot Disabled Hidden Checked" BugrunSpiderLoot)).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 w13 h13 vBugrunMantisLoot Disabled Hidden Checked" BugrunMantisLoot)).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 w13 h13 vBugrunScorpionsLoot Disabled Hidden Checked" BugrunScorpionsLoot)).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 w13 h13 vBugrunWerewolfLoot Disabled Hidden Checked" BugrunWerewolfLoot)).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "x48 y120 vBugrunLadybugsCheck Disabled Hidden Checked" BugrunLadybugsCheck, "Ladybugs")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vBugrunRhinoBeetlesCheck Disabled Hidden Checked" BugrunRhinoBeetlesCheck, "Rhino Beetles")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vBugrunSpiderCheck Disabled Hidden Checked" BugrunSpiderCheck, "Spider")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vBugrunMantisCheck Disabled Hidden Checked" BugrunMantisCheck, "Mantis")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vBugrunScorpionsCheck Disabled Hidden Checked" BugrunScorpionsCheck, "Scorpions")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+18 vBugrunWerewolfCheck Disabled Hidden Checked" BugrunWerewolfCheck, "Werewolf")).Section := "Collect", GuiCtrl.OnEvent("Click", nnm_saveCollectKillConfig)
	SetLoadingProgress(floor((CurrentLoadProgress+140)/LoadingProgressVolume*100))
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "x315 y43 vStingerDailyBonusCheck Disabled Hidden Checked" StingerDailyBonusCheck, "Only Daily Bonus")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "x152 y123 vKingBeetleCheck Disabled Hidden Checked" KingBeetleCheck, "King Beetle")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+21 vTunnelBearCheck Disabled Hidden Checked" TunnelBearCheck, "Tunnel Bear")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    ...
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+21 vStumpSnailCheck Disabled Hidden Checked" StumpSnailCheck, "Stump Snail")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+21 vCommandoCheck Disabled Hidden Checked" CommandoCheck, "Commando")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "x270 y123 w13 h13 vKingBeetleBabyCheck Disabled Hidden Checked" KingBeetleBabyCheck)).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
    (GuiCtrl := MainGui.Add("CheckBox", "xp yp+21 w13 h13 vTunnelBearBabyCheck Disabled Hidden Checked" TunnelBearBabyCheck)).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
	...
	CurrentLoadProgress:=CurrentLoadProgress+CollectKillFeatureProgressVolume
...
nm_MemoryMatchOptions(*){
	...
	(GuiCtrl := MMGui.Add("CheckBox", "x122 y+3 vMemoryMatchInterruptCheck Checked" MemoryMatchInterruptCheck, "Allow Gather Interrupt")).Section := "Collect", GuiCtrl.OnEvent("Click", nm_saveCollectKillConfig)
...
nm_saveCollectKillConfig(GuiCtrl, *){
	global
	...
	IniWrite %GuiCtrl.Name%, collectKillConfigLoc, GuiCtrl.Section, GuiCtrl.Name
}
