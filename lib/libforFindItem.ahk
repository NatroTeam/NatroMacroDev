...
localfindItem(input) {
	...
	*/
	...
	ItemNumber := itemNumbers[firstDetectedItem] ;called twice so why not make it a variable
	...
	x := spritcords[1]+windowX, y := spritcords[2]+150
